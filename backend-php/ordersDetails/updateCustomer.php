...
$stmt = $conn->prepare("
  ...
  SET customer_name=?, usd_to_collect=?, delivery_charge_usd=COALESCE(?, delivery_charge_usd)
  WHERE id=? AND user_id=? AND status='pending'
");
$stmt->bind_param("sddii", $customer_name, $usd_to_collect, $delivery_charge_usd, $id, $user_id);
