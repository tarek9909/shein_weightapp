...
router.post(paths("updateCart"), asyncHandler(async (req, res) => {
  ...
  const hasWeightG = Object.prototype.hasOwnProperty.call(req.body || {}, "shein_total_weight_g");
  const hasWeightKg = Object.prototype.hasOwnProperty.call(req.body || {}, "shein_total_weight_kg");
  const hasPlus2 = Object.prototype.hasOwnProperty.call(req.body || {}, "shein_total_weight_plus_2kg");
  const weightKg = hasWeightKg ? nullableNumber(req.body.shein_total_weight_kg) : (existing.shein_total_weight_kg == null ? null : Number(existing.shein_total_weight_kg));
  const weightG = hasWeightG ? nullableNumber(req.body.shein_total_weight_g) : (hasWeightKg ? (weightKg == null ? null : Math.round(weightKg * 1000)) : (existing.shein_total_weight_g == null ? null : Number(existing.shein_total_weight_g)));
  const plus2 = hasPlus2 ? nullableNumber(req.body.shein_total_weight_plus_2kg) : (hasWeightKg ? (weightKg == null ? null : weightKg + 2) : (existing.shein_total_weight_plus_2kg == null ? null : Number(existing.shein_total_weight_plus_2kg)));
