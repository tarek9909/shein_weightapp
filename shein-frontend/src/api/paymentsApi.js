...
export const getPayments = (month_id) =>
  apiFetch(`${BASE_URL}/getPayments?month_id=${month_id}`);

export const addPayment = (month_id, payment_amount) =>
  apiFetch(`${BASE_URL}/addPayment`, {
    method: "POST",
...
export const updatePayment = (id, payment_amount) =>
  apiFetch(`${BASE_URL}/updatePayment`, {
    method: "POST",
    body: JSON.stringify({ id, payment_amount }),
  });

export const deletePayment = (id) =>
  apiFetch(`${BASE_URL}/deletePayment`, {
    method: "POST",
...
export const getPaymentCustomers = (month_id, q = "") =>
  apiFetch(
    `${BASE_URL}/getPaymentCustomers?month_id=${encodeURIComponent(month_id)}&q=${encodeURIComponent(q)}`
  );

export const getPaymentItems = (payment_id) =>
  apiFetch(`${BASE_URL}/getPaymentItems?payment_id=${encodeURIComponent(payment_id)}`);
