...
export const resetPassword = (old_password, new_password, confirm_password) =>
  apiFetch(`${BASE_URL}/resetPassword`, {
    method: "POST",
    body: JSON.stringify({ old_password, new_password, confirm_password }),
  });

export const getManagedUsers = () => apiFetch(`${BASE_URL}/users`);
...
export const updateManagedUser = (id, role) =>
  apiFetch(`${BASE_URL}/updateUser`, { method: "POST", body: JSON.stringify({ id, role }) });

export const setManagedUserActive = (id, is_active) =>
  apiFetch(`${BASE_URL}/disableUser`, { method: "POST", body: JSON.stringify({ id, is_active }) });

export const deleteManagedUser = (id) =>
  apiFetch(`${BASE_URL}/users/${id}`, { method: "DELETE" });

export const resetManagedUserPassword = (id, password) =>
  apiFetch(`${BASE_URL}/resetUserPassword`, { method: "POST", body: JSON.stringify({ id, password }) });
